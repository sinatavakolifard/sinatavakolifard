<h1 align="center">Hi there, I'm Sina 👋</h1>

<p align="center">
  <b>SDET Automation Engineer & Full-Stack Web Developer</b><br>
  Building reliable web apps with React, TypeScript & Node.js — and making sure they stay that way with test automation.
</p>
...
- 🌐 Full-stack developer focused on **React, TypeScript, Node.js & Express.js**
- 🧪 **SDET Automation Engineer** — I care about clean code *and* test automation
- 🐍 Comfortable across the stack with **Python** (FastAPI, Whisper, spaCy) and **Flutter/Dart**
- 🐧 Linux tinkerer — running **Hyprland on Arch** (yes, I rice my desktop)
- 🌍 Check out my work at **[sinacodes.de](https://sinacodes.de)**
...
![Allure](https://img.shields.io/badge/Allure_Report-FF7B00?style=flat-square&logoColor=white)
...
| **[dotfiles](https://github.com/sinatavakolifard/dotfiles)** | My Hyprland-on-Arch desktop configuration. | `Hyprland` `CSS` |
